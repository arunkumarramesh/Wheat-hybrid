...
## centromere bed from table s11 from wheat paper
...
Rscript boman_classification_cg_te.R
Rscript boman_classification_chg_te.R
Rscript boman_classification_chh_te.R 
```
