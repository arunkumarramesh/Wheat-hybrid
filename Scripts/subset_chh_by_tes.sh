...
awk 'BEGIN{FS=OFS="\t"}
{
    key=$13 OFS $14 OFS $15 OFS $16 OFS $17 OFS $18 OFS $19 OFS $20 OFS $21 OFS $22 OFS $23 OFS $24 OFS $25 OFS $26 OFS $27 OFS $28 OFS $29 OFS $30 OFS $31
    ...
    meth_CSxP[key]+=$9*$10/100
    cov_CSxP[key]+=$10

    meth_P[key]+=$11*$12/100
    cov_P[key]+=$12
}
END{
    for(i=1;i<=n;i++){
